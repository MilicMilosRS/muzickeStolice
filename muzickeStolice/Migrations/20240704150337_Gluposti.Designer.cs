...
namespace muzickeStolice.Migrations
{
    ...
    [Migration("20240704150337_Gluposti")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("muzickeStolice.Model.Bend", b =>
                {
                    ...
                    b.Property<string[]>("slikeLinkovi")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("muzickeStolice.Model.GlasZaAlbum", b =>
                {
                    ...
                    b.HasKey("KorisnikEmail", "AlbumId", "Godina");
            ...
            modelBuilder.Entity("muzickeStolice.Model.GlasZaAlbum", b =>
                {
                    b.HasOne("muzickeStolice.Model.MuzickoDelo", "Album")
                        .WithMany()
                        .HasForeignKey("AlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("muzickeStolice.Model.Korisnik", "Korisnik")
                        .WithMany()
            ...
            modelBuilder.Entity("muzickeStolice.Model.Ocena", b =>
                {
                    b.HasOne("muzickeStolice.Model.Korisnik", "Autor")
                        .WithMany()
                        .HasForeignKey("autorEmail")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("muzickeStolice.Model.Ocenljivo", "Primalac")
                        .WithMany()
